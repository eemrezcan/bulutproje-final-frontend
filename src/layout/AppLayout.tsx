...
import { Activity, BrainCircuit, Gauge, LayoutDashboard, RadioTower, Video } from "lucide-react";

const navItems = [
  { to: "/dashboard", label: "Dashboard", icon: LayoutDashboard },
  { to: "/iot", label: "IoT", icon: RadioTower },
  { to: "/video", label: "Video", icon: Video },
  { to: "/ml", label: "ML Analytics", icon: BrainCircuit }
];
        ...
        <header className="sticky top-0 z-10 border-b border-slate-200 bg-white/95 backdrop-blur">
          <div className="flex h-16 items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
            <div className="min-w-0">
              ...
              <p className="truncate text-xs text-slate-500">IoT, Video ve ML Service canli veri akisi</p>
            </div>
